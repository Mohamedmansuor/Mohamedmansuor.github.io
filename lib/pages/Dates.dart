...
class Dates extends StatelessWidget {
  final List<DatesModel> cards = [
    DatesModel(
      imagePath: "images/jess/photo1.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo1.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo3.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo2.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo4.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo3.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo5.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo4.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo6.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo5.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo7.webp",
      sentence: 'How this day feels:',
      audioPath: "sounds/photo6.wav",
    ),
    DatesModel(
      imagePath: "images/jess/photo8.webp",
      sentence: 'How this day feels:',
